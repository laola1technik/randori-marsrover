...
class NavigationTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $navigation = new Navigation($this->map, new Position(0, 0), new Compass(new North()));
    ...
    public function shouldSetInitialPosition()
    {
        ...
        $navigation = new Navigation($this->map, $initialPosition, new Compass(new North()));
    ...
    public function shouldWrapUsingMapPositionWhenMovingForward()
    {
        ...
        $navigation = new Navigation($this->map, $position, new Compass(new North()));
    ...
    public function shouldWrapUsingMapPositionWhenMovingBackwardWithMock()
    {
        ...
        $position = new Position(5, 0);
        $navigation = new Navigation($map, $position, new Compass(new North()));
    ...
    public function shouldCheckIfAbleToMoveForwardWhenFacingObstacle($obstaclePosition, $roverPosition)
    {
        ...
        $navigation = new Navigation($this->map, $roverPosition, new Compass(new North()));
    ...
    {
        $navigation = new Navigation($this->map, new Position(1, 1), new Compass(new North()));
